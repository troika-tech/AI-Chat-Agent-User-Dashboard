        ...
        try {
          ...
          if (formData.scriptFile) {
            try {
              ...
              alert(`Campaign "${formData.name}" created successfully with ${phoneNumbers.length} numbers! Script uploaded. Waiting for approval.`);
              ...
              alert(`Campaign created but failed to update status: ${updateErr.response?.data?.error || updateErr.message}`);
            }
          }
